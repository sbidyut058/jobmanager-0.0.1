...
class CronExp extends BaseObject {
    ...
    #validate () {
        const cronRegex = {
            second: /^(\*|([0-5]?\d)(\/[1-9]\d?)?|([0-5]?\d)-([0-5]?\d)(\/[1-9]\d?)?)$/,
            minute: /^(\*|([0-5]?\d)(\/[1-9]\d?)?|([0-5]?\d)-([0-5]?\d)(\/[1-9]\d?)?)$/,
            hour: /^(\*|([01]?\d|2[0-3])(\/[1-9]\d?)?|([01]?\d|2[0-3])-([01]?\d|2[0-3])(\/[1-9]\d?)?)$/,
            dayOfMonth: /^(\*|([1-9]|[12]\d|3[01])(\/[1-9]\d?)?|([1-9]|[12]\d|3[01])-([1-9]|[12]\d|3[01])(\/[1-9]\d?)?)$/,
            month: /^(\*|(1[0-2]|0?[1-9])(\/[1-9]\d?)?|(1[0-2]|0?[1-9])-(1[0-2]|0?[1-9])(\/[1-9]\d?)?)$/,
            dayOfWeek: /^(\*|[0-6](\/[1-9]\d?)?|[0-6]-[0-6](\/[1-9]\d?)?)$/
        };        
